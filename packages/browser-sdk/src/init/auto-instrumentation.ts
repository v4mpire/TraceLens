...
import { SDKConfig, validateConfig } from '../config/sdk-config';

export interface AutoInstrumentationOptions extends Partial<SDKConfig> {
  autoStart?: boolean;
}

export function autoInstrument(options: AutoInstrumentationOptions = {}): TraceLensSDK {
...
function setupVisibilityHandling(sdk: TraceLensSDK): void {
...
function setupUnloadHandling(sdk: TraceLensSDK): void {
...
if (typeof window !== 'undefined') {
  ...
  const globalConfig = (window as any).TRACELENS_CONFIG;
